...
public:
	...
	TDelegate<void(EInputType InputType)>         K2Node_CreateDelegate_OutputDelegate_1;            // 0x002C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable_1;                              // 0x003C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FST_InputDeviceImage                   CallFunc_Map_Find_Value;                           // 0x0040(0x00A0)(ContainsInstancedReference, HasGetValueTypeHash)
	...
	class UBP_ConfigSaveGame_C*                   K2Node_DynamicCast_AsBP_Config_Save_Game;          // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IBPI_LightBPGI_C>      K2Node_DynamicCast_AsBPI_Light_BPGI;               // 0x0108(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UBPGI_Main_C*                           CallFunc_GetBPGI_Main_Object;                      // 0x0120(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x0128(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EInputType                                    K2Node_CustomEvent_InputType;                      // 0x0129(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_CustomEvent_IsController;                   // 0x0158(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FST_InputDeviceImage                   K2Node_Select_Default_1;                           // 0x0160(0x00A0)(ConstParm, ContainsInstancedReference, HasGetValueTypeHash)
};
