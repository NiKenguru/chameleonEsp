...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09C7F5A0;
	constexpr int32 AppendString      = 0x013B04A0;
	constexpr int32 GNames            = 0x09E51280;
	constexpr int32 GWorld            = 0x09CB6270;
	constexpr int32 ProcessEvent      = 0x015CE920;
